...
(* OASIS_START *)
(* DO NOT EDIT (digest: 015693cf714ec300bdc287afa2610505) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_mustache", []))];
          ...
          ("spec",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$spec_mustache", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "enable compilation of cli utility";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "test_mustache.ml"});
               Executable
                 ({
                     cs_name = "spec_mustache";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "spec_mustache.ml"});
               Executable
                 ({
                     cs_name = "mustache_example";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "examples";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "mustache"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = true; exec_main_is = "mustache_example.ml"});
               Executable
                 ({
                     cs_name = "mustache_cli";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "mustache_cli.ml"})
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\154C\240\146(\028\183\134:\213\1914C\001\004\223";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
